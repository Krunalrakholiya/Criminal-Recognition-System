...
def insert():
    try:
        ...
        os.rename(Binarydata,'C:/Users/akhil/PycharmProjects/Criminal_Detection_System/image/'+str(Criminal_id)+'.jpg')
        Binarydata1='C:/Users/akhil/PycharmProjects/Criminal_Detection_System/image/'+str(Criminal_id)+'.jpg'
        ...
        msg.showinfo("Alert","This id data is allready exist in database")
#=======================================================Delete Button==============================================
def delete():
    try:
        id=e_id.get()
        if(id==""):
            ...
            os.remove('C:/Users/akhil/PycharmProjects/Criminal_Detection_System/image/'+ str(id) + '.jpg')
...
def get_encoded_faces():
    ...
    for dirpath, dnames, fnames in os.walk('C:/Users/akhil/PycharmProjects/Criminal_Detection_System/image/'):
        for f in fnames:
            if f.endswith(".jpg") or f.endswith(".png"):
                face = fr.load_image_file('C:/Users/akhil/PycharmProjects/Criminal_Detection_System/image/' + f)
...
def video():
    path = 'C:/Users/akhil/PycharmProjects/Criminal_Detection_System/image/'
    images = []
    classNames = []
